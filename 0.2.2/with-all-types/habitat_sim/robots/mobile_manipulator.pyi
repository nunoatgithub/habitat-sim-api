...
class MobileManipulator(RobotInterface):
    ...
    params: Incomplete
    _fix_joint_values: Incomplete
    _sim: Incomplete
    _limit_robo_joints: Incomplete
    _fixed_base: Incomplete
    sim_obj: Incomplete
    _cameras: Incomplete
    ...
    def _validate_joint_idx(self, joint) -> None: ...
    def _set_motor_pos(self, joint, ctrl) -> None: ...
    def _get_motor_pos(self, joint): ...
    def _set_joint_pos(self, joint_idx, angle) -> None: ...
    def _interpolate_arm_control(self, targs, idxs, seconds, ctrl_freq, get_observations: bool = False): ...
    def _update_motor_settings_cache(self) -> None: ...
