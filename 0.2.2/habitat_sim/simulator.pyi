...
from habitat_sim.nav import GreedyGeodesicFollower as GreedyGeodesicFollower, NavMeshSettings as NavMeshSettings
...
class Simulator(SimulatorBackend):
    ...
    def make_greedy_follower(self, agent_id: int | None = None, goal_radius: float = None, *, stop_key: Any | None = None, forward_key: Any | None = None, left_key: Any | None = None, right_key: Any | None = None, fix_thrashing: bool = True, thrashing_threshold: int = 16): ...
